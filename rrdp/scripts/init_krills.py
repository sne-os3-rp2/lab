...
subprocess.call(f"docker exec -it krill_unmodified_1 /usr/bin/python3 data_generator.py --token itworks --host https://localhost:3000 --count {no_ca} --roadepth {roa_depth} --sleeptime {sleep_time} -pr {ca_prefix} -sr {start_range}", shell=True)
